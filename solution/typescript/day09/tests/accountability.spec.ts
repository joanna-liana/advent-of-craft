import {
  Client
} from '../src/accountability'; // Adjust the import path as needed
...
describe('Client Tests', () => {
  ...
  test('returns statement on first call', () => {
    let statement = client.toStatement();
  ...
  test('returns correct statemement when called again', () => {
    let statement = client.toStatement();
    statement = client.toStatement();
